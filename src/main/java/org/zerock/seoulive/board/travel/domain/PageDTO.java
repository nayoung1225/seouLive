...
public class PageDTO {
    ...
    public PageDTO(Criteria criteria, int totalAmount) {
        this.cri = criteria;
        ...
        //----------------------------------------------------------//
        // 총 페이지 수보다 현재 페이지의 끝 페이지가 작거나 같은 경우에도 다음 페이지로 이동 가능
        this.next = this.endPage < realEndPage || currPage < realEndPage;
